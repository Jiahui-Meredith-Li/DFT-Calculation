...
fractional_coordinates = [[ 0.437565297644,  0.1042451372  ,  0.373035920234],
                          ...
                          [ 0.604151171385,  0.187261327922,  0.635210210822],
                          [ 0.103981598478,  0.187149194496,  0.635184181637],
                          [ 0.937194092293,  0.353784512091,  0.635210435706],
                          [ 0.437343420537,  0.353932702998,  0.635176231687],
                          [ 0.603947199371,  0.687190627579,  0.635212028882],
                          [ 0.104001827079,  0.687260587266,  0.635176309545],
                          [ 0.937398101772,  0.853917774898,  0.635211936978],
                          [ 0.437363658216,  0.853841916218,  0.63518410492 ]]
...
nlsave('WSiN-Gr-d2.hdf5', bulk_configuration)
...
nlsave('WSiN-Gr-d2.hdf5', fat_bandstructure)

# -------------------------------------------------------------
# Total Energy
# -------------------------------------------------------------
total_energy = TotalEnergy(bulk_configuration)
nlsave('WSiN-Gr-d2.hdf5', total_energy)
